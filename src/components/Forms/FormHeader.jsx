...
export const FormHeader = ({title}) => {
  return (
    <div className="sm:mx-auto sm:w-full sm:max-w-sm text-dark-light">
      <div className="grid place-content-center">
        <Logo customStyle={"w-12"} />
      </div>
      <h2 className="mt-10 text-center text-3xl font-bold leading-9 tracking-tight  flex flex-col gap-2">
        {title}
